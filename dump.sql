...
CREATE TABLE `sinistro` (
  ...
  `dataOcorrenciaSinistro` date DEFAULT NULL,
  `valorReparacaoSinistro` double DEFAULT NULL,
  `fkIdSeguroSinistro` int DEFAULT NULL,
  `descricaoSinistro` varchar(85) DEFAULT NULL,
  PRIMARY KEY (`idSinistro`),
  KEY `fkIdSeguroSinistro` (`fkIdSeguroSinistro`),
  CONSTRAINT `sinistro_ibfk_1` FOREIGN KEY (`fkIdSeguroSinistro`) REFERENCES `seguro` (`idSeguro`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-17 22:27:18
